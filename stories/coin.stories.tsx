...
export const Image = () => <CoinImage image={coinDetails.image} title={coinDetails.title} />;
export const Profile = () => <CoinDetails coin={coinDetails} breadCrumbLinks={breadCrumbLinks} />;
