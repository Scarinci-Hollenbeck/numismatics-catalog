...
const coins = [
  {
    ...
    "description": "Obv: Alfonso XII Por La G De Dios 1874-1885, Rev: El Pacificador Barcelona MCMLXII",
    "category": "Calico Kings and Queens of Spain",
    "imageUrl": "http://res.cloudinary.com/numismatics-catalog/image/upload/v1601061183/coins/kw2osskjam04mvgiokef.jpg",
...
describe('Coin Detail Component', () => {
  ...
  it('the coin article list contains sourceUrl and title', () => {
    ...
    expect(coins[1]).toHaveProperty('imageUrl', "http://res.cloudinary.com/numismatics-catalog/image/upload/v1601061183/coins/kw2osskjam04mvgiokef.jpg");
  });

  it('matches snapshot', () => {
    const tree = renderer.create(<CoinDetails coin={coins[0]} crumbs={crumbs} />).toJSON();
